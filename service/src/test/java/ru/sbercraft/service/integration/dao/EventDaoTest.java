...
import ru.sbercraft.service.util.CreateDML;
...
class EventDaoTest {
    ...
    void checkEventById() {
        ...
        Assertions.assertThat(event.getName()).isEqualTo("Баскетбол");
        Assertions.assertThat(event.getCategory()).isEqualTo(CategoryEvent.SPORT);
    ...
    void checkEventFilterReturnOneValue() {
        ...
        Assertions.assertThat(event.size()).isEqualTo(1);
        Assertions.assertThat(event.get(0).getName()).isEqualTo("Java");
        Assertions.assertThat(event.get(0).getCategory()).isEqualTo(CategoryEvent.SCIENCE);
    ...
    void checkEventFilterReturnEmpty() {
        ...
        Assertions.assertThat(event.size()).isEqualTo(0);
    ...
    void checkThatWithEventReturnAndSchedule() {
        ...
        Assertions.assertThat(mayBeEvent.get().getSchedules().size()).isEqualTo(2);
    }
}