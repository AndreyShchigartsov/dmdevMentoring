...
public class CreateDML {
    ...
    public void createData(SessionFactory sessionFactory) {
        ...
        Room room3 = saveRoom(session, 101, 4, structureDivision71);
        ...
        Camper camper1 = saveCamper(session, room5, "Sergey", structureDivisionVita, Role.USER);
    ...
    private Camper saveCamper(Session session, Room room, String username, StructureDivision structure, Role role) {
    ...
    private Worker saveWorker(Session session, Room room, String username, StructureDivision structure, Role role, JobPosition jobPosition) {
    ...
    private StructureDivision saveStructureDivision(Session session, StructureDivision structureDivisionParent, Structure structure, String name) {
        StructureDivision structureDivision = StructureDivision.builder()
                .parentId(structureDivisionParent)
                .typeStructure(structure)
                .name(name)
                .build();
        session.persist(structureDivision);
